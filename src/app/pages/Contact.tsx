        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#16A34A]">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-[#16A34A] font-bold text-sm hover:underline"
              >
                <MessageCircle size={16} /> WhatsApp Us
              </a>
              <a
                href="mailto:admissions@themaker.eg"
                className="flex items-center gap-2 text-gray-600 hover:text-[#16A34A] text-sm"
              >
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#D97706]">
            ...
            <div className="space-y-3">
              <Link
                to="/scouts"
                className="flex items-center gap-2 text-[#D97706] font-bold text-sm hover:underline"
              >
                Go to Scouts Portal →
              </Link>
              <a
                href="mailto:scouting@themaker.eg"
                className="flex items-center gap-2 text-gray-600 hover:text-[#D97706] text-sm"
              >
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-teal-600">
            ...
            <Link
              to="/schools"
              className="flex items-center gap-2 text-teal-600 font-bold text-sm hover:underline"
            >
              Schools Programme →
            </Link>
          </div>
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            {status === "success" ? (
              ...
              >
                <h3 className="font-bold text-lg mb-1">Thanks — message received.</h3>
                <p className="text-sm text-gray-600">
                  We’ll be in touch within 48 hours. If your request is urgent, feel free to
              ...
              <form
                ...
                className="space-y-5 bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#16A34A] focus:outline-none focus:ring-2 focus:ring-[#16A34A]/30"
                    />
                    {showError("name") && (
                      <p
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#16A34A] focus:outline-none focus:ring-2 focus:ring-[#16A34A]/30"
                    />
                    <p id="contact-phone-hint" className="mt-1 text-xs text-gray-500">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm bg-white focus:border-[#16A34A] focus:outline-none focus:ring-2 focus:ring-[#16A34A]/30"
                    >
                ...
                <div>
                  <label className="flex gap-3 items-start text-sm text-gray-600">
                    ...
                    <span>
                      ...
                      <Link to="/privacy" className="text-[#16A34A] font-bold hover:underline">
                        Privacy Policy
                      </Link>
                      .
                    </span>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 pt-8 border-t border-gray-100">
              ...
              <p className="text-sm text-gray-500">
                For matters related to Enosis Paralimni or SC Farense partnerships, please
                contact our International Relations department.
              </p>
            </div>
          </div>
        </div>

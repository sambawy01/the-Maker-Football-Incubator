 ...
 *
 * Motion: layered GradientMesh + GrainOverlay for tech-modernity polish.
 * Headline lines, body, CTAs, trust strip fade-up with a slow stagger on
 * load. Primary CTA wrapped in MagneticButton. All primitives respect
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="max-w-3xl">
          <motion.span
            variants={fadeUp}
            className="inline-flex items-center gap-2 text-[#16A34A] font-bold text-xs md:text-sm tracking-widest uppercase mb-5 px-3 py-1.5 rounded-full bg-[#16A34A]/10 border border-[#15803D]/30"
          >
